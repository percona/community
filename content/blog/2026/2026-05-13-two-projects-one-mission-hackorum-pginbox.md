---
title: "Two projects, one mission - hackorum and pginbox join forces"
date: "2026-05-13T10:00:00+00:00"
tags: ["Percona", "PostgreSQL", "Community", "pg_kwagner"]
categories: ['PostgreSQL']
authors:
  - kai_wagner
images:
  - blog/2026/05/hackorum-pginbox.png
---

Last week, Zsolt and I jumped on a call with someone who had been building something remarkably similar to what we had been working on, completely independently. That someone is Jack Bonatakis, the creator of [pginbox.dev](https://pginbox.dev/), and that call turned into one of the most energizing conversations we've had since launching [hackorum.dev](https://hackorum.dev/).
...
If you haven't tried Hackorum yet, visit [hackorum.dev](https://hackorum.dev/). And if you want to get involved, here's how:

- 💬 **Join the conversation** and hop into our [Hackorum Discord channel](https://discordapp.com/channels/1258108670710124574/1471524461374083186) to ask questions, share ideas, or just follow along as we build.
- 🛠️ **Explore the code,** everything is open source and available on [GitHub](https://github.com/hackorum-dev/hackorum).
- 🐛 **Report a bug or request a feature,** we track everything in the our [GitHub Issues](https://github.com/hackorum-dev/hackorum/issues).
