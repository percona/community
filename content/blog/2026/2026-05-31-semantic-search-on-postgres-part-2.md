---
title: "Building Smart Semantic Search using PostgreSQL and pgvector. Case Study - Part 2 - Postgres Layer"
...
This time, with [percona.community](https://percona.community), went better: the agent set up Compose, `ensure_*`, search SQL, and the admin dashboard, without that series of failures at startup. More time was spent on the logic (chunks, `min_score`, result ordering) rather than on “why the database won’t start.”
