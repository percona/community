...
date: "2026-03-06:00:00+00:00"
tags: ['PostgreSQL', 'Opensource', 'pg_zsolt', 'OIDC', 'Security']
categories: ['PostgreSQL']
authors:
  - zsolt_parragi
images:
  - blog/2026/03/oidc-errors.png
---
...
But if somebody is observant enough, this message is logged before we even go to the device authentication website of Keycloak, and enter the authentication code.
