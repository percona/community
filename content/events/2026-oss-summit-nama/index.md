...
- 👤 **Conference URL:** https://events.linuxfoundation.org/open-source-summit-north-america/ 
- 👤 **Location:**  Minneapolis, Minnesota

As a Silver Sponsor of Open Source Summit North America 2026, Percona is excited to join the global open source community May 18–20 in Minneapolis at the Minneapolis Convention Center. This premier event brings together developers, technologists, and industry leaders to collaborate, innovate, and share real-world solutions—making it an essential gathering for anyone passionate about open source and the technologies shaping the future.

Percona’s presence is vital in helping organizations navigate the ever-evolving database landscape with trusted, open source solutions and deep technical expertise. Be sure to stop by booth #8 in the Solutions Showcase for fresh Percona swag, expert discussions, exciting giveaways, and all the information you need to see how Percona can make a meaningful impact on your database management strategy.
