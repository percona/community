---
title: The Journey to Achieve 1000x TPS for a Real-World Core Banking Application
  on TiDB
description: Performance tuning is more challenging when the whole system is running
  on arm64-based servers
images:
