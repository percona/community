...
description: Percona organized a meetup with the local community in Ulyanovsk (Russia).
  Engineers discussed with Peter databases, Kubernetes as a modern trend and when
  you need to use it, pg_stat_monitor and other stuff.
images:
...
events_year: ["2021"]
events_tag: ["Cloud Native", "In-Person", "PostgreSQL"]
