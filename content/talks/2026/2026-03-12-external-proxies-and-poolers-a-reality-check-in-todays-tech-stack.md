...
- Video
- Slides
slides: https://github.com/jobinau/presentations/blob/master/External_Proxies_and_Poolers_A_reality_check_in_todays_techstack.pdf
video: https://youtu.be/WEpDPamRqGY
youtube_id: WEpDPamRqGY
images:
